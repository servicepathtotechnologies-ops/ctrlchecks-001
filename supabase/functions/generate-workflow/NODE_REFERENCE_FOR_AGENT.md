# Node Reference Guide for AI Agent
# Simplified node information for accurate workflow generation

This document provides essential node information in a concise format for the AI agent to generate accurate workflows.
