...
// Note: This component should be moved to src/components/model-testing/ when ready
          ...
          <div className="flex items-start gap-3">
            <div className="text-sm">
              ...
              <div className="text-xs text-muted-foreground mt-2">
                These should be set in your .env file and Supabase Edge Functions secrets.
              </div>
            </div>
          </div>
        </CardContent>
